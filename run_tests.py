...
fails = 0
for name in ("tests.test_routers", "tests.test_framework", "tests.test_edit", "tests.test_reroute", "tests.test_tidy", "tests.test_ports", "tests.test_tool", "tests.test_editor"):
